...
form_class = uic.loadUiType('ui/pills_count_v1.ui')[0]
...
########################################################################################################################
    ...
    def contour(self,img_proc):
        ...
        large_pill = 0
        small_pill = 0
        large_flag = 0  #self.label_6
        small_flag = 0  #self.label_5
        ...
        self.lcdNumber_5.display(large_pill) # 현재 큰 알약
        self.lcdNumber_6.display(small_pill) # 현재 작은 알약
